<template>
    <div class="aumain" style="width: 100%;height: 44vh;">
        <div class="auNetBox"></div>
    </div>
    <!-- <div class="container">
        <el-container>
            <el-header class="header" style="width: 100%;height: 10vh;">AuthorNetwork</el-header>
        </el-container>
        <div class="aumain" style="width: 100%;height: 40vh;">
            <div class="auNetBox"></div>
        </div>
    </div> -->
</template>
...
// import testGraph from '../../../output_data/auNet_Draw.json'
import testGraph from '../../../output_data/auNet_Draw10.json'
...
export default {
    ...
    setup(props, { emit }) {
        ...
        function initGraph(data, n) {
            ...
            const element = document.querySelector(".aumain");
            ...
            d3.select('.auNetBox').selectAll("svg").remove();
            const svg = d3.select('.auNetBox')
                .append("svg")
                .attr("width", width)
                .attr("height", height)
...
/* .auNetBox {
    ...
    background: #52264d repeating-linear-gradient(30deg,
